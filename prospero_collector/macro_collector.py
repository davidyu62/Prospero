...
FRED_SERIES = {
    ...
    "vix": "VIXCLS",                         # VIX 지수
    "goldPrice": "GOLDAMGBD228NLBM",         # 금 가격 (런던 오후 현물가)
...
def get_macro_data(date: str, fred_api_key: str) -> Optional[dict]:
    ...
    Returns: {interestRate, treasury10y, cpi, m2, unemployment, dollarIndex, vix, goldPrice, oilPrice, yieldSpread, breakEvenInflation}
    """
    if not fred_api_key:
